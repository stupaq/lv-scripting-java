...
public class example {
  ...
  private static void run(String[] args) throws Exception {
    if (args.length == 1) {
      ...
      Wire vi0w1 = new Wire(vi0t1, vi0t3, "wire 1");
      ...
      Wire vi0w2 = new Wire(vi0c0.terminal(), vi0i0.terminal(), "wire 2");
      ...
      Wire vi0w3 = new Wire(vi0sub0.terminals().get(0), vi0i1.terminal(), "wire 3");
      vi0.cleanUpDiagram();
      vi0b3.delete();
      //t2.delete();
    } else {
